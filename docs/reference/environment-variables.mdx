...
## Workspace runtime hardening

See [runtime hardening](../runtime-hardening.md) for scheduled principal resolution, cleanup recovery, real health probes and SSE replay limits in the workspace fork.
